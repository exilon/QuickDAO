...
const
  UserNames : array[0..13] of string = ('Cliff','Alan','Anna','Phil','John','Michel','Jennifer','Peter','Brandon','Joe','Steve','Lorraine','Bill','Tom');
  UserSurnames: array[0..13]  of string = ('Gordon','Summer','Huan','Paterson','Johnson','Michelson','Smith','Peterson','Miller','McCarney','Roller','Gonzalez','Thomson','Muller');

var
  DAODatabase : TDAODataBaseSQLite3;
  User : TUser;
